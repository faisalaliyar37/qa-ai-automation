/**
 * WebdriverIO Configuration - Web (Chrome)
 * 
...
exports.config = {
    ...
    suites: {
        login: ['./test/specs/login.unified.e2e.js'],
        zenda: ['./test/specs/zenda.login.e2e.js'],
        web: ['./test/specs/web.e2e.js']
    },

    capabilities: [{
        maxInstances: 1,
        browserName: 'chrome',
        browserVersion: '144.0.7559.110',
